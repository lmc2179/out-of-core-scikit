...
class TestDataAccess(object):
    def read(self, data_source, input_fields, output_field):
        ...
        input_batches = all_inputs[:2], all_inputs[2:],all_inputs[:2], all_inputs[2:],all_inputs[:2], all_inputs[2:]
        if output_field is None:
            return input_batches
        all_outputs = [o for o in test_data[output_field]]
        output_batches = all_outputs[:2], all_outputs[2:],all_outputs[:2], all_outputs[2:],all_outputs[:2], all_outputs[2:]
